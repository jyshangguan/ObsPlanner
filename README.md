...
The current release is **ObsPlanner 0.2.2**.

[Download ObsPlanner 0.2.2 for macOS (Apple Silicon, ZIP)](https://github.com/jyshangguan/ObsPlanner/releases/download/v0.2.2/ObsPlanner-0.2.2-macOS-arm64.zip)
...
The v0.2.2 ZIP release uses the locally signed build and is not Apple-notarized.
