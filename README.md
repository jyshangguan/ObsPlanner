...
The current release is **ObsPlanner 0.2.0**.

[Download ObsPlanner 0.2.0 for macOS (Apple Silicon, ZIP)](https://github.com/jyshangguan/ObsPlanner/releases/download/v0.2.0/ObsPlanner-0.2.0-macOS-arm64.zip)
...
The v0.2.0 ZIP release uses the locally signed build and is not Apple-notarized.
